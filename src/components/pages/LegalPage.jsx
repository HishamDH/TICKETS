            ...
            <div className="container mx-auto max-w-4xl">
                ...
                >
                    ...
                    <p className="text-lg text-gray-600">
                        الشروط والأحكام وسياسة الخصوصية التي تحكم استخدامك لمنصة شباك التذاكر.
                    </p>
                </motion.header>
                    ...
                    >
                        <TabsContent value="terms">
                            <Card className="mt-6 shadow-lg">
                                <CardHeader>
                                    <CardTitle>شروط وأحكام استخدام منصة شباك التذاكر</CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-4 text-gray-700 leading-relaxed">
                                    <h3 className="font-bold text-xl">1. مقدمة</h3>
                                    <p>مرحباً بك في منصة "شباك التذاكر". هذه الشروط والأحكام توضح القواعد التي تحكم استخدامك لخدماتنا. باستخدامك للمنصة، فإنك توافق على هذه الشروط بالكامل.</p>
                                    
                                    <h3 className="font-bold text-xl">2. الحسابات</h3>
                                    <p>عند إنشاء حساب معنا، يجب عليك تزويدنا بمعلومات دقيقة وكاملة وحديثة دائمًا. عدم القيام بذلك يشكل خرقًا للشروط، مما قد يؤدي إلى الإنهاء الفوري لحسابك على خدمتنا.</p>
                                    
                                    <h3 className="font-bold text-xl">3. الملكية الفكرية</h3>
                                    <p>المنصة ومحتواها الأصلي وميزاتها ووظائفها هي وستظل ملكية حصرية لـ "شباك التذاكر" ومرخصيها. خدمتنا محمية بموجب حقوق النشر والعلامات التجارية والقوانين الأخرى.</p>
                        ...
                        <TabsContent value="privacy">
                            <Card className="mt-6 shadow-lg">
                                <CardHeader>
                                    <CardTitle>سياسة الخصوصية لمنصة شباك التذاكر</CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-4 text-gray-700 leading-relaxed">
                                    <h3 className="font-bold text-xl">1. جمع المعلومات</h3>
                                    <p>نقوم بجمع أنواع مختلفة من المعلومات لأغراض متنوعة لتوفير وتحسين خدمتنا لك. قد نطلب منك تزويدنا بمعلومات تعريف شخصية معينة يمكن استخدامها للاتصال بك أو التعرف عليك.</p>
                                    
                                    <h3 className="font-bold text-xl">2. استخدام البيانات</h3>
                                    <p>تستخدم "شباك التذاكر" البيانات التي تم جمعها لأغراض مختلفة: لتوفير الخدمة وصيانتها، لإعلامك بالتغييرات التي تطرأ على خدمتنا، للسماح لك بالمشاركة في الميزات التفاعلية لخدمتنا عندما تختار القيام بذلك، ولتقديم دعم العملاء.</p>
