...
const UnifiedView = ({ handleFeatureClick, handleNavigation }) => {
    return (
        <div className="min-h-screen bg-slate-50 py-12 px-4 md:px-8">
            ...
            >
                ...
                <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                    تجربة شاملة لكل الأدوار في المنصة. تنقل بين لوحات تحكم العميل، التاجر، الشريك، والإدارة بسهولة.
                </p>
            </motion.div>
            ...
            <Tabs defaultValue="merchant" className="w-full" dir="rtl">
                <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 gap-2 h-auto p-2 bg-primary/10 rounded-xl mb-6 max-w-4xl mx-auto">
                    ...
                    <TabsTrigger value="merchant" className="flex items-center justify-center gap-2 text-sm md:text-base py-2.5 data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-lg"><Store className="h-5 w-5"/>لوحة التاجر</TabsTrigger>
                ...
                >
                    <div className="rounded-2xl overflow-hidden border border-slate-200/80 shadow-2xl bg-white">
                        <TabsContent value="customer">
                            <CustomerDashboard handleFeatureClick={handleFeatureClick} handleNavigation={handleNavigation} />
                        </TabsContent>
                        <TabsContent value="merchant">
                            <MerchantDashboard handleFeatureClick={handleFeatureClick} />
                        </TabsContent>
                         <TabsContent value="partner">
                            <PartnerDashboard handleFeatureClick={handleFeatureClick} />
                        </TabsContent>
                        <TabsContent value="admin">
                            <AdminDashboard handleFeatureClick={handleFeatureClick} />
                        </TabsContent>
                    </div>
                </motion.div>
            </Tabs>
